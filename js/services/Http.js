(function($moa) {
    ...
    $moa.service('http', ['$q', '$http', 'config', function httpService($q, $http, config) {
        ...
        service.getProduct = function getProduct(id) {
            return $http.get(service.url + 'product/getDetails/id/' + id);
        };
        ...
        service.addBasket = function addBasket(id, quantity) {
			return $http.post(service.url + 'basket/add/id/' + id + '/quantity/' + quantity);
        };
        ...
        service.removeBasket = function removeBasket(id) {
            return $http.get(service.url + 'basket/remove/id/' + id);
        };
		...
		service.getProducts = function getProducts() {
			return service._request(service.url + 'products');
        };
